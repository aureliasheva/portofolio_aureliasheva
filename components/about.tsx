      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-3">
            <div className="flex justify-between"><span className="text-white">Nama</span><span className="font-medium text-white">Aurelia Sheva Denathrya</span></div>
            <Separator className="bg-blue-500" />
            <div className="flex justify-between"><span className="text-white">Lokasi</span><span className="font-medium text-white">Magelang, Jawa Tengah</span></div>
            <Separator className="bg-blue-500" />
            <div className="flex justify-between"><span className="text-white">Email</span><span className="font-medium text-white">Aurelarl2024@gmail.com</span></div>
            <Separator className="bg-blue-500" />
            <div className="flex justify-between"><span className="text-white">Tersedia untuk</span><span className="font-medium text-green-600">Freelance / Fulltime</span></div>
          </div>
        </div>
      </div>
    </section>
